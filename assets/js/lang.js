var arrLang = {
    'en': {
      ...
      'things_i_can_do': "I'm trying to gather information about all test tools apply them to the appropriate project. I'm also building web projects and generally virtualize the data or automize the test process. I have also started a master's degree to investigate how to use software tests with AI.",
      'blog_post': "I have started to write articles about software test. You can also follow from Medium.",
      'software_test':"Software Test Engineer",
      'biss':"I've been focusing to improve software test progress in agile with our software test team. I'm developing the UI test automation with written manual test cases according to related projects and also writing API tests and load tests which should be realized according to our test progress. Also, we have been running embedded device tests.",
      'nevalabs': "I have written manual test cases for web-based face recognition applications and then built UI test automation system according to these manual test cases. I have written API test cases for the necessary features. We have automatized the CI-CD pipeline via Jenkins, Jira, and Github. I was doing Regression tests before the installation step. I was also in charge of installing the application. I was also doing Camera tests according to ONVIF for connection and face recognition.",
